...
| 9 | "Muammo → yechim → natija" (boshlandi 2026-09-17) | Ilova bo'lim katalogi emas, savolga javob bo'lsin. **9.1 ✓** bosh sahifadagi tez o'tish plitkalari bo'lim nomidan savolga o'tdi: "Qayerdan olsam?", "Qancha tushadi?", "Qaysi kuryer?", "Ruxsat bormi?" (tartib xarid yo'li bo'yicha, metrika kalitlari o'zgarmadi). Qoladi: 9.2 kuryerlar — avval natija, keyin ro'yxat; 9.3 do'kon kartasida qaror bloki; 9.4 bojxona 6 bo'lim o'rniga 3 savol; 9.5 qo'llanma oxirida amal tugmasi; 9.6 "Posilka ushlandi" oqimi; 9.7 pastki menyu nomlari | 9.1: smoke 189 yashil, uch tilda plitkalar savol shaklida |
| 10 | Keyingi | havola tahlili (ochiq do'konlar), Score, real tracking | alohida topshiriq |
