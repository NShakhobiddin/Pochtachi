...
| 20 | Keyingi bosqichlar | 4) sodda til (jargon → oddiy so'z) va Bojxona 3 sahifaga, Reja sehrgari taqdiri; 5) hamkor kuryer holat API (trek bo'yicha holat o'zi yangilanadi) | alohida topshiriq |
