...
| 23 | Bosh sahifa — hammasi AI orqali ✓ (2026-09-26) | Maydon "Havola yoki tovar nomini yozing" (mikrofon ichida), ostida 3 qatorli qo'llanma; nom → darhol AI (find, aniq havolalar, "Topish" kartasi), havola → AI sahifani o'qiydi, savol → AI; "Hali topmadim / Qanaqasi / Byudjet" bosqichi olib tashlandi; ovoz aytib bo'lingach o'zi qidiradi, tanilmasa klaviatura mikrofoni maslahati; AI qoidasi: so'rov ko'pincha faqat nom (ovozdan, xatolar bilan) | bajarildi |
