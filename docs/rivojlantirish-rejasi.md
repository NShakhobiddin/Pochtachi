...
| 18 | Keyingi bosqichlar | 2) "Xarid kartasi" — reja, jo'natma, hisob, sevimli bitta obyekt (Topish → Narx → Buyurtma → Yo'lda → Keldi); 3) "Kuryer men uchun sotib olsin" va trek maydoni; 4) sodda til va Bojxona 3 sahifaga; 5) hamkor kuryer holat API | alohida topshiriq |
